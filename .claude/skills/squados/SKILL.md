...
| `/squados create <description>` | Load Architect → Create Squad flow (will ask for reference profile URLs for Sherlock investigation) |
...
2. Present the skills submenu using AskUserQuestion (max 4 options):
   ...
   - **Create a custom skill** — Create a new skill (uses squados-skill-creator)
