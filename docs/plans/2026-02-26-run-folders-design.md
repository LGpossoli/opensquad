...
### Core (runner)
- `_squados/core/runner.pipeline.md` — Add "Run Folder Creation" section after step execution rules
- `templates/_squados/core/runner.pipeline.md` — Mirror same change
...
### Architect
- `_squados/core/architect.agent.yaml` — Update squad creation instructions re: output structure
