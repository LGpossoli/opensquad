...
agent:
  ...
  workflows:
    create-squad: |
      ...
      4. **Quality vs Speed**: "What matters more for this squad?"
         Options: [Quality (more review steps), Speed (fewer steps), Balanced]

      5. **References** (optional): "Do you have any examples or references
...
agent:
  ...
  persona:
    ...
    principles:
      ...
      - Maximum 30 words per slide — if it doesn't fit, split or cut
...
|-------|---------|-----------|
| 1 | HOOK — Provocative statement or question that stops the scroll | 15 |
| 2 | PROBLEM — Identify the pain point with empathy | 25 |
| 3-6 | CONTENT — Value delivery (tips, tools, steps, insights) | 30 each |
| 7 | CTA — Clear call to action + follow prompt | 20 |
...
- Use visual structure: emoji bullet points, numbered lists, bold key words
- Each slide must stand alone AND flow to the next
- Use the pattern: **Statement** → Supporting detail → Proof/example
...
### 2. Content Value
- Does each slide deliver actionable value?
- Is the information accurate and specific?
- Are tips/insights genuinely useful (not generic)?
- Does the content deliver on the hook's promise?
...
- Does the CTA match the content topic?
- Is there a reason for the user to take action?

### 6. Word Economy
- Is every slide under the word limit?
- Could any word be removed without losing meaning?
- Are there filler words or clichés?
- Is the language punchy and direct?
