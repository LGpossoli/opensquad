# Sherlock — Content Investigator for SquadOS
...
```
_squados/_investigations/{squad-code}/
├── {platform}-{username}/
...
Investigations saved in `_squados/_investigations/`. Enables:
...
```
User: /squados create "Instagram carousel squad"
