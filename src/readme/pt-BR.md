...
**Pré-requisitos:** Node.js 20+ e [Claude Code](https://claude.com/claude-code).
...
Abra esta pasta no Claude Code e digite:

```
/opensquad
```

Isso abre o menu principal. De lá você pode criar squads, executá-los, abrir o Escritório Virtual e mais.
...
/opensquad execute o squad my-squad
```
...
**Passo 1 — Gere o dashboard** (no Claude Code):
